...
Domains register through the ``agentkart.domains`` entry point, so a third-party
...
ENTRY_POINT_GROUP = "agentkart.domains"
...
class Domain:
    ...
    Deliberately small. If adding a domain requires touching :mod:`agentkart.core`,
    ...
    #: ``"agentkart.domains.dataengineering"``. Its ``skills/`` directory is the
...
class DomainRegistry:
    ...
    BUILTIN: dict[str, str] = {
        "dataengineering": "agentkart.domains.dataengineering:DOMAIN",
        "code": "agentkart.domains.code:DOMAIN",
    }
